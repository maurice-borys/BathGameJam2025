...
func enteredRange(body : Node2D):
	inRange.append(getHealthModule(body))
	
func exitedRange(body : Node2D):
	inRange.erase(getHealthModule(body))
	
func enteredRangeSpecial(body : Node2D):
	inRangeSpecial.append(getHealthModule(body))
	
func exitedRangeSpecial(body : Node2D):
	inRangeSpecial.erase(getHealthModule(body))
...
func getHealthModule(object : Node2D) -> Health:
